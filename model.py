...
Original file is located at
    https://colab.research.google.com/drive/1tc0Fsymfxw4mXMNvKIvlhK7hwWhNekgt
...
class Activation:
  ...
  def get_activation_signal(self, length, frequency, duty_cycle, amp, non_linearity):
    ...
    on = amp * np.ones((1000* self.length)* self.duty_cycle//100 )

    off = np.zeros(period - on)
...
length, frequency, duty_cycle, amp, non_linearity = 2, 5, 50, 1, -2
